(function() {
     ...
     * @ngInject
     */
    //function ResetController ($scope, $state, $stateParams, $translate, $window, AuthService ) {
    function ResetController ($translate, $state, $stateParams, $scope, $window,  AuthService) {
